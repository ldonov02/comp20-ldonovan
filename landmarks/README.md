...
Correctly implemented: implement navigator.geolocation, send location to datastore and parse response,  put parsed data into associative arrays, load map, place marker for myself/places/people, make 1 info window total whose information updates for each object clicked on

Incorrectly implemented: transparent images, haversine formula
